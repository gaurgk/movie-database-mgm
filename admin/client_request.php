...
.social i.fa.fa-google-plus{background:#ce4d39;}
  ...
  <div class="container">
    ...
    <h1 class="text-center" style="margin-top:  130px;"><strong>CLIENT REQUESTS</strong></h1>

    <div class="container text-center" style="margin-top: 100px; margin-bottom: 90px;">
    <table class="table table-hover table-bordered table-responsive">
           
              <tr>
                <th class="text-center">CLIENT NAME</th>
                <th class="text-center">CLIENT PHONE</th>
                <th class="text-center">TICKET BOOKED</th>
                <th class="text-center">CLIENT ID</th>
                 <th class="text-center">MOV_ID</th>
              ...
              <?php
                ...
                $select = "SELECT client.id_no,client.fname,client.phone,movies.mov_id,movies.mov_name,movies.tcost,client.status 
                    FROM client JOIN movies ON client.mov_id=movies.mov_id";
              ...
              <tr>
                ...
                <td><a href="javascript:sureToApprove(<?php echo $row['mov_id'];?>)" style="padding-right: 60px">Approve</a><a href="javascript:sureToDelete(<?php echo $row['mov_id'];?>)">Delete</a></td>
              </tr>
            </tbody>
              <?php
                }
  ...
  <div class="container">
        ...
        <p>Developed by <a href="#" target="_blank">Gaurav Kuamr</a> &amp <a href="#" target="_blank">Jannat Malhotra</a></p></div>
